...
// Structure information end
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("Transducer_1_0")).setPreferredLocation(new Point(8, 140));
        ((ViewableComponent)withName("Generator")).setPreferredLocation(new Point(243, 238));
    }
    }
